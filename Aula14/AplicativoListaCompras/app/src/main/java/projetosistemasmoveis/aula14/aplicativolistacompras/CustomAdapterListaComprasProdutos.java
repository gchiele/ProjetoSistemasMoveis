...
public class CustomAdapterListaComprasProdutos extends ArrayAdapter<Produto> {

    private ArrayList<Produto> produtos;
    private int selectedItem = -1; // Índice do item selecionado

    public CustomAdapterListaComprasProdutos(Context context, ArrayList<Produto> produtos) {
