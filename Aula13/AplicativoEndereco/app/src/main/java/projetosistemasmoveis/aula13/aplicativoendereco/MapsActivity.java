...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void BotaoNovaPesquisa(View view) {
    ...
    private class GetJson extends AsyncTask<Void, Void, PessoaObj> {
        ...
        protected void onPreExecute(){
            load = ProgressDialog.show(MapsActivity.this,
                    "Por favor Aguarde ...", "Buscando Informaçoes...");
        }
        ...
        protected void onPostExecute(PessoaObj pessoa){
            mMap.clear();
            LatLng Posicao = new LatLng(pessoa.getLatitude(), pessoa.getLongitude());

            MarkerOptions markerOptions = new MarkerOptions();
            markerOptions.title("Nome: "+pessoa.getNome());
